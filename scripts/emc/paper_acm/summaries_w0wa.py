...
data_dir = f'/global/cfs/cdirs/desicollab/users/epaillas/acm/fits_emc/abacus/optimal/apr11/c002_hod013/w0wa/'
...
plt.savefig('summaries_w0wa.png', dpi=300, bbox_inches='tight')
plt.savefig('summaries_w0wa.pdf', bbox_inches='tight')